...
def launch_setup(context: LaunchContext, *args, **kwargs):
  ...
  #   'Grid/RangeMinHeight': '-0.3',
   # 'Grid/RangeMaxHeight': '0.3',   
  ...
  nodes = [
    ...
    Node(
      ...
      output='screen',
      parameters=['/home/alex/ros2_ws/src/rtabmap/params/ekf_params.yaml'])
  ]
  ...
  if not localization:
    ...
    nodes.append(      
      Node(
        package='rtabmap',          # replace with your actual package name
        executable='camera_lidar_saver',   # the name of the Python executable (without .py)
...
def generate_launch_description():
  return LaunchDescription([
    ...
    DeclareLaunchArgument(
      'lidar_topic', default_value='/ouster/points',
    ...
    DeclareLaunchArgument(
      ...
      description='Path to the RTAB-Map database to load or save'),
    
    DeclareLaunchArgument(
      'publish_tf_map', default_value='true',
      description='publish tf map'),
